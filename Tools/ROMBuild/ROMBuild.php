  ...
  <body>
	...
	<p>
      <img src="ROMBuild.gif" width="120" height="40" alt="ROMBuild.gif"/>
		...
		<p>
			When used in conjunction with the <a href="../../Dats/Dats.shtml" target="">CMPro/ROMCenter dats</a> that I have produced you can generate ROM sets for practically any emulator from MAME ROMs. In fact, the only ROMs you can't generate from MAME sets are where MAME doesn't support the game.
		</p>
