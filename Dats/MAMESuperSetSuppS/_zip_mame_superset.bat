...
zip "MAME SuperSet %MAME_VER_CURRENT% (Split-merged MAME Supplement) (cm).zip" "MAME SuperSet %MAME_VER_CURRENT% *Supplement*"
...
zip "MAME SuperSet %MAME_VER_CURRENT% (Split-merged MAME Supplement) (rc).zip" "MAME SuperSet %MAME_VER_CURRENT% *Supplement*"
