...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		<?php
			...
			echo '<title>Logiqx - Non-MAME games for Various Emulators (Split-merged SuperSet Supplements) History</title>' . LF . LF;
	...
	<body>
		...
		?>
					...
					<p>Previous Non-MAME games for Various Emulators (Split-merged SuperSet Supplements) Releases</p>

					<table class="news">
						<tr>
							<?php
								echo '<td><p>' . LF;
								foreach (glob("*.* (cm).zip") as $filename)
								{
