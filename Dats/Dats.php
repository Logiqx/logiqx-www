...
<tr>
        ...
        <td>
          <p>
			...
			<tr>
        <td>
          <a href="MAMESuperSet/">MAME SuperSet v0.133</a>
        </td>
        <td>
          <p>
            <img src="../Resources/Updated.png" width="73" height="14" alt="Updated"/>
        ...
        <td>
          <p>
			...
			<tr>
        <td>
          <a href="MAMESuperSetSuppM/">MAME SuperSet (Fully-merged MAME Supplement) v0.133</a>
        </td>
        <td>
          <p>
            <img src="../Resources/Updated.png" width="73" height="14" alt="Updated"/>
        ...
        <td>
          <p>
			...
			<tr>
        <td>
          <a href="MAMESuperSetSuppS/">MAME SuperSet (Split-merged MAME Supplement) v0.133</a>
        </td>
        <td>
          <p>
            <img src="../Resources/Updated.png" width="73" height="14" alt="Updated"/>
        ...
        <td>
          <p>
			...
			<tr>
        <td>
          <a href="MAMESuperSetEmusM/">Various Emulators (Fully-merged SuperSet Supplements) v0.133</a>
        </td>
        <td>
          <p>
            <img src="../Resources/Updated.png" width="73" height="14" alt="Updated"/>
        ...
        <td>
          <p>
			...
			<tr>
        <td>
          <a href="MAMESuperSetEmusS/">Various Emulators (Split-merged SuperSet Supplements) v0.133</a>
        </td>
        <td>
          <p>
            <img src="../Resources/Updated.png" width="73" height="14" alt="Updated"/>
    ...
    <p>
      <img src="RecentEmus.png" width="158" height="40" alt="RecentEmus.png"/>
			...
			<p>Emulators that are up to a year old, still active or likely to receive further updates.<br/>These data files correspond to the <a href="http://caesar.logiqx.com/php/emulators.php?id=recent">recent emulators</a> listed at CAESAR.</p>
...
<tr>
        ...
        <td>
          <p>35</p>
			...
			<tr>
        <td>
          <a href="FinalBurnAlpha/">FBA v0.2.97.06</a>
        </td>
        <td>
          <p/>
        </td>
...
<tr>
        <td>
          <a href="WinKawaks/">Kawaks v1.60</a>
        </td>
        <td>
          <p/>
        </td>
...
<tr>
        ...
        <td>
          <p>781</p>
			...
			<tr>
        <td>
          <a href="SEGAModel2Emulator/">SEGA Model 2 Emulator v0.9</a>
        </td>
        <td>
          <p/>
        </td>
...
<tr>
    ...
    <p>
      <img src="Systems.png" width="104" height="40" alt="Systems.png"/>
			...
			<p>General systems used by multiple emulators.</p>
...
<tr>
        <td>
          <a href="Neo-Geo/">Neo-Geo 20090725</a>
        </td>
        <td>
          <p>
            <img src="../Resources/Updated.png" width="73" height="14" alt="Updated"/>
